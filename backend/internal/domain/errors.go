...
var (
	...
	ErrEmailAlreadyTaken   = errors.New("domain: email is already registered")
	ErrInvalidCredentials  = errors.New("domain: invalid email or password")
	ErrWeakPassword        = errors.New("domain: password must be at least 8 characters")
)
